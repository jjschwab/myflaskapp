...
def classify_scenes(scene_frames, description_phrases):
    scene_categories = {}
...
def test_video_processing(video_path):
    try:
        ...
        scene_frames = extract_frames(video_path, scenes)
        print("Classifying scenes...")
        scene_categories = classify_scenes(scene_frames, ["Action", "Context"])  # Use appropriate descriptions
...
if __name__ == "__main__":
    video_path = "final_concatenated_clip(4).mp4"  # Replace with your actual video file path
